...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/docusign/**", "/api/v1/googleOauth/**", "/api/v1/documents/signing-complete").permitAll()
                        .requestMatchers("/api/v1/documents/**", "/api/v1/webhook/**", "/api/v1/agreements/**").authenticated()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList(
                "https://contract-image-latest.onrender.com"
        ));
